...
test_that("correctly specified functions execute without error", {
  expect_error(get_deprivation(geography = "county", variables = "gini", state = "MO", year = 2019, debug = TRUE), NA)
})

result1 <- get_deprivation(geography = "county", variables = "gini", state = "MO", year = 2019, debug = TRUE)
